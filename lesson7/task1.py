...
origin_list = [randint(-100, 100) for i in range(1000)]
...
Вариант с доработкой выполняется дольше в большинстве случаев.
...
def bubble_sort3(lst_obj):  # Это чтобы сделать частично отсортированный массив
    n = 1
